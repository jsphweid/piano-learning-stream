...
loss_op = tf.reduce_sum(tf.square(tf.subtract(y_, y_conv)))
...
with tf.Session() as sess:
	...
	for i in range(50000):
		...
		batch_xs, batch_ys = dataProvider.getTrainingBatch(10)
		...
		if i % 10 == 0:
			test_xs, test_ys = dataProvider.getTrainingBatch(10)
